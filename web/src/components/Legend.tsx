  ...
  return (
    <div className="legend" data-testid="legend">
      ...
      <p className="legend-note">
        Click a node or edge to inspect it. Drag to rearrange, scroll to
        zoom, type in search to filter. The graph updates live from the
        agent&rsquo;s eBPF event stream.
      </p>
    </div>
  );
}
